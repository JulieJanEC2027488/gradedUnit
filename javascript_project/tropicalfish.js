...
{   
    ...
    currScene.load.image("background", "javascript_project/Images/background2.png")
    currScene.load.image("gameover-screen", "javascript_project/Images/gameover-screen.png")
    currScene.load.image("button-left", "javascript_project/Images/button-left.png")
    currScene.load.image("button-right", "javascript_project/Images/button-right.png")
    currScene.load.image("player", "javascript_project/Images/player-left.png")
    currScene.load.image("player", "javascript_project/Images/player-right.png")
    currScene.load.image("aquarium", "javascript_project/Images/aquarium.png")
    currScene.load.image("dead-fish", "javascript_project/Images/fish-heaven.png")
    currScene.load.image("fish", "javascript_project/Images/fish.png")
    currScene.load.image("life", "javascript_project/Images/life.png")
    currScene.load.image("full-aquarium", "javascript_project/Images/full-aquarium.png")



    //LOAD AUDIO

    currScene.load.audio("startFX", "javascript_project/sounds/start-sound.wav")
    currScene.load.audio("caughtFX", "javascript_project/sounds/fish-caught-sound.wav")
    currScene.load.audio("jumpFX", "javascript_project/sounds/fish-jump-sound.wav")
    currScene.load.audio("savedFX", "javascript_project/sounds/fish-moved-sound.wav")
    currScene.load.audio("dieFX", "javascript_project/sounds/fish-die-sound.wav")
    currScene.load.audio("gameoverFX", "javascript_project/sounds/gameover-sound.wav")
    ...
    currScene.load.spritesheet("fishswim", "javascript_project/Images/fishAni.png", fishSwimConfig)
